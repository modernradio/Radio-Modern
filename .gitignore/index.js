    ...
    "botinfo": {
        process: function (msg, suffix) {
            ...
            var reseaux_embed = new Discord.RichEmbed()
                ...
                .addField("Facebook <:facebook:432513421507035136>", "[@radiomodern1](http://" + facebook + ")") 
                .addField("Twitter <:twitter:432513453899382794>", "[@radiomodern_](http://" + twitter + ")", true)
                .addField("Page de don :money_with_wings:", "[Notre PayPal](http://" + paypal + ")", true)
                .setTimestamp()
                .setFooter("Par Ilian ! ^^")
            var log_embed = new Discord.RichEmbed()
                .setThumbnail(msg.author.displayAvatarURL)
